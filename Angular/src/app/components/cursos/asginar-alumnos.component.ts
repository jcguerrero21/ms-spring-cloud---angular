...
@Component({
  selector: 'app-asginar-alumnos',
  templateUrl: './asginar-alumnos.component.html',
  styleUrls: ['./asginar-alumnos.component.scss']
})
export class AsginarAlumnosComponent implements OnInit {
  ...
  mostrarColumnos: string[] = ['nombre', 'apellido', 'seleccion'];
  ...
  asignar(): void {
    this.cursoService.asignarAlumnos(this.curso, this.seleccion.selected)
      .subscribe(c => {
        ...
        Swal.fire(
          'Asignados',
          `Alumnos asigandos con éxito al curso ${c.nombre}`,
          'success'
        );
  ...
  eliminarAlumno(alumno: Alumno): void {
    Swal.fire({
      title: 'Cuidado',
      text: `¿Seguro qué desea eliminar a ${alumno.nombre}?`,
      icon: 'warning',
