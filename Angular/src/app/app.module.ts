...
import { AsginarAlumnosComponent } from './components/cursos/asginar-alumnos.component';
...
@NgModule({
  ...
  providers: [
    {provide: MAT_DIALOG_DEFAULT_OPTIONS, useValue: {hasBackdrop: true}} //para que se vea el background del modal oscuro o no
  ],
